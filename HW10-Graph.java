...
public int edgecost( Vertex start, Vertex goal) 
{
	...
	for (Edge ee : e)
	{
		//String c = (e.get(0).target).contents;
		//String c1 = v.contents;
		if ((ee.target).contents.equals(start.contents))
		{
			cost = ee.cost;
		}
	}
...
public int totalcost( ) 
{
	...
	for (int i = 0; i < v.length; i++)
	{
		...
		ArrayList<Edge> e = vi.edges;
		for (Edge ee : e)
		{
			//String c = (e.get(0).target).contents;
			//String c1 = vi.contents;
			//System.out.println(c+" "+c1+" "+e.get(0).cost);
			cost += ee.cost;
		}
	}
	return cost/2;
