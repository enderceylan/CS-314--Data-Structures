...
public static Cons match(Object pattern, Object input) {
    return matchb(pattern, input, algpats); }
...
// empty buffers into a music string
   ...
   // you should not need to change this function
    ...
    public static PriorityQueue<Object> initpq(Cons action) {
    ...
    public static PriorityQueue<Object>
           addevent(PriorityQueue<Object> pq, Cons action, int time) {
        if ( action != null ) pq.add(new Event(action, time));
        return pq; }

    // you should not need to change this function
    // if the queue is not empty, remove the next event and execute it
        public static void simulator(PriorityQueue<Object> pq) {
        while ( pq.size() > 0 ) {
    ...
    // execute an event
    public static void execute(PriorityQueue<Object> pq, Cons act, int time) {
